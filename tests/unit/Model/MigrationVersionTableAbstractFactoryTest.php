...
class MigrationVersionTableAbstractFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function test_it_indicates_what_services_it_creates()
    {
        ...
        'migrations.versiontable.foo'), "should indicate it provides service for \$name");

        $this->assertTrue($factory->canCreate($this->service_manager,
            'migrations.versiontable.foo'), "should indicate it provides service for \$requestedName");
    ...
    {
        $factory = new MigrationVersionTableAbstractFactory();
        $instance = $factory($this->service_manager, 'migrations.versiontable.foo');
        ...
        $instance2 = $factory($this->service_manager, 'migrations.versiontable.foo');
